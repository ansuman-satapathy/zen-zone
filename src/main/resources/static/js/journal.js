        ...
        fetch(url, {
            ...
            .then(journal => {
                if (action === 'update') {
                    ...
                    showConfirmationDialog('Journal entry updated successfully. Please refresh the page to see the changes.', function() {
                        location.reload();
                    });
                } else {
                ...
                document.querySelector('button[type="submit"]').textContent = 'Add Journal';
            })
            .catch(error => {
                console.error('Error:', error.message);
            });
